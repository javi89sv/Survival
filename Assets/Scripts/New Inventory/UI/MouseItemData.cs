...
public class MouseItemData : MonoBehaviour
{
    ...
    public void DropItem()
    {
        ...
        if (!isPointerOverUIObject())
        {
            ...
            {
                GameObject go = Instantiate(assignedInventorySlot.item.prefab, playerTransform.position + playerTransform.forward * 1f + playerTransform.up * 2, Quaternion.identity);
